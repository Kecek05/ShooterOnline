...
namespace AssetInventory
{
    ...
    public class SetupWizardPreviewPage : WizardPage
    {
        ...
        public override void Draw()
        {
            ...
            EditorGUILayout.HelpBox("Previews are usually extracted from the packages. These are rather small usually (128x128px). Activating the upscaling will provide larger previews for image files at the cost of additional storage space.", MessageType.Info);
            EditorGUILayout.Space();
